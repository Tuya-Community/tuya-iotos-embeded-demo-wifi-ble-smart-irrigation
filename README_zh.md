# Tuya IoTOS Embeded Demo WiFi & BLE Soil irrigator

[English](./README.md) | [中文](./README_zh.md)

## 简介 

本 Demo 基于涂鸦智能云平台、涂鸦智能APP、IoTOS Embeded WiFi &Ble SDK，使用涂鸦WiFi/WiFi+BLE系列模组快速组建一款智能灌溉控制器，实现手机远程监测土壤湿度数据，自动控制设备浇水。
## 快速上手
